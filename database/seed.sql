...
(2,'found','book','Found: Operating Systems Textbook - Reading Room','Found an Operating Systems textbook with handwritten notes on Chapter 5 in the reading room.','Central Library',28.6139,77.2090,'2025-04-04','15:20:00','9123456780','What is written on the first page?','R. Mehta - CS B','active'),
(4,'found','calculator','Found: Casio Scientific Calculator - Lecture Hall 2','Found a Casio calculator under seat B12 after the afternoon class in Lecture Hall 2.','Lecture Hall 2',28.6137,77.2089,'2025-04-04','12:40:00','9871234560','What model is the calculator?','FX-991ES Plus','active'),
(6,'found','usb_drive','Found: 32GB USB Drive near CS Lab 1','Found a black 32GB USB drive labeled "Project Viva" near the entrance of CS Lab 1.','Lab Block - CS Lab 1',28.6134,77.2084,'2025-04-05','10:10:00','9654321009','What label is on the USB drive?','Project Viva','active'),
(8,'found','earbuds','Found: White Earbuds in Main Canteen','Found white wireless earbuds in a charging case on table 3 in the main canteen.','Main Canteen',28.6142,77.2094,'2025-04-05','13:05:00','9432100987','What brand are the earbuds?','Realme','active'),
(10,'found','laptop','Found: HP Laptop Sleeve - Department Block','Found a grey HP laptop sleeve outside room D-204 in the department block corridor.','Department Block',28.6141,77.2093,'2025-04-06','09:50:00','9000000001','What color is the sleeve zip pull?','Blue','active'),
(1,'found','wallet','Found: Student Wallet near Hostel Block B','Found a dark brown wallet near Hostel Block B cycle stand containing one student card and receipts.','Hostel Block B',28.6130,77.2080,'2025-04-06','18:15:00','9876543210','What is the dominant color of the wallet?','Dark Brown','active');
